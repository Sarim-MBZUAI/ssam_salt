...
source_path = os.path.join("/l/users/sarim.hashmi/for_the_little_interns/the_experiments/svd_only/datasets")
...
def parse_args():
    ...
    parser.add_argument(
        "--data_config",
        default="/l/users/abdelrahman.elsayed/the_experiments/svd_only/config_arcade.yml",
        help="data config file path",
    )

    parser.add_argument(
        "--model_config",
        default="/l/users/abdelrahman.elsayed/the_experiments/svd_only/model_svdtuning.yml",
...
def main_train(
    ...
    if data_config["data"]["name"] == "LITS":
        ...
        # Get dataset sizes
        dataset_sizes = {split: len(dataset_dict[split]) for split in ["training", "val"]}
        ...
        # Print dataset sizes
        print(f"Train dataset size: {dataset_sizes['training']}")
