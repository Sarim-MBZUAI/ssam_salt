...
def main_train(
    ...
    if data_config["data"]["name"] == "LITS":
        ...
        #         exp_lr_scheduler,
        #         save_path,
        #         save_dir="./crf_experiments/vanilla/",
        #         num_epochs=training_params["num_epochs"],
        #         bs=training_params["batch_size"],
        #         device=device,
        #         retain_graph=retain_graph,
        ...
        #         reg_multiplier=model_config["training"]["reg_multiplier"],
        #     )
        print("running with CRF")
        param_grid = {
            "n_iter": [5, 10],
            "filter_size": [15,17],
            "smoothness_weight": [0.5, 0.7],
        }
        ...
        for params in combinations:
            ...
            copy_model = CRFCombinedModel(model,crf)
            optimizer = optim.AdamW(
        ...
        gamma=training_params["schedule_step_factor"],
            ...
            train_dl(
                ...
                exp_lr_scheduler,
                save_path,
                save_dir=f"./crf_experiments/{params}/",
                num_epochs=training_params["num_epochs"],
                bs=5,
                device=device,
                retain_graph=retain_graph,
