...
def main_train(
    ...
    if data_config["data"]["name"] == "LITS":
        ...
        rewardmodel = RewardModel(save_dir=os.path.join(data_config['data']['root_path'].split('/')[-1], "_rhlf"))
        rewardmodel = rewardmodel.to(device)
        train_rlhf(model ,model_config,label_dict, rewardmodel , train_datatloader,30)
